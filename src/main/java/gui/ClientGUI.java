...
public class ClientGUI {
    ...
    private static ThreadPoolScheduler tps;
    
    public static void main(String[] args) {
    	ClientGUI gui = new ClientGUI();
    	
    	tps = new ThreadPoolScheduler(4);
    ...
    class AnalysisListener implements ActionListener {
    	public void actionPerformed(ActionEvent event) {
    		...
    		Double result = tps.sentimentAnalysis(cname_input.getText(), begin_input.getText(), end_input.getText(), 4);
        	...
        	String[] row_res = new String[]{"1",cname_input.getText(),begin_input.getText(),end_input.getText(),result.toString()};
